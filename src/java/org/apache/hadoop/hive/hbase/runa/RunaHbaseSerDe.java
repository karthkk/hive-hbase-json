...
public class RunaHbaseSerDe implements SerDe {
	  ...
	  public RunaHbaseSerDe() throws SerDeException {
	  }
	  ...
	  public void initialize(Configuration conf, Properties tbl)
	    ...
	    cachedHBaseRow = new LazyRunaHbaseRow(
	  ...
	  private void initHBaseSerDeParameters(
	    ...
	    String hbaseColumnNameProperty =
	      tbl.getProperty(RunaHbaseSerDe.HBASE_COL_MAPPING);
